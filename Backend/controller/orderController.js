...
const placeOrder = async (req, res) => {
  try {
    ...
    if (!user) {
      return res.json({ success: false, message: "User not found" });
        ...
        typeof user.phone === "string"
          ...
          ? user.phone.toString()
          : "9090407368"; // fallback valid number
      
      console.log("Phone being sent:", phone); // 👈 ADD THIS LINE HERE
      ...
      const body = {
        ...
        customer_details: {
          ...
          customer_phone: phone, // 👈 use the cleaned phone here
        },
    ...
    console.log("Cashfree Request Payload:", body);
  } catch (error) {
